...
exports.uploadImages = async (req, res) => {
    try {
        const existingObject = await serviceRepo.get({ _id: req.query._id }, { images: 1 })
...
exports.deleteImages = async (req, res) => {
    try {
        ...
        await imagesToDelete.map((pathToFile) => {
            operationResultObject = serviceRepo.updateDirectly(req.query._id, { $pull: { images: { key: pathToFile } } });
        });
