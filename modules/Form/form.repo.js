...
exports.list = async (filterObject, selectionObject, sortObject, pageNumber, limitNumber) => {
    try {
        ...
        const count = await formModel.count(filterObject);
        return {
            success: true,
            code: 200,
            result: resultArray,
...
exports.create = async (formObject) => {
    try {
        ...
        const resultObject = new formModel(formObject);
...
exports.update = async (_id, formObject) => {
    try {
        ...
        const resultObject = await formModel.findByIdAndUpdate({ _id }, formObject, { new: true, select: "-password" });
