...
const notificationSchema = new mongoose.Schema({
    ...
    type: { type: String, enum: ["admin", "message", "serviceRequest", "servicePriceUpdate", "serviceRequestRejected", "serviceRequestCancel", "order", "activate", "deactivate", "changeData", "creation"] },
});
